...
namespace Merchandiser.Controllers.api.v1.breeze
{
    ...
    public class ProductTypeDetailApiController : ApiController
    {
        ...
        [HttpGet]
        public IQueryable<ProductTypeDetailViewModel> Search(int companyId)
        {
        ...
        [HttpGet]
        public ProductTypeDetailViewModel Get(int id)
        {
        ...
        [HttpPut]
        public IHttpActionResult Update(int id, ProductTypeDetailViewModel item)
        {
